  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 style={sx('font-family:var(--font-instrument),serif;font-size:28px;line-height:1.1;margin:0 0 12px;font-weight:400')}>{glosAktif.term}</h2>
        <p style={sx('margin:0;font:400 16px/1.7 var(--font-outfit),sans-serif;color:var(--ink-2);text-wrap:pretty')}>{glosAktif.def}</p>
        <button
          onClick={closeGlos}
